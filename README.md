...
|------------------|------------------------|------------------------------------------------|-------|
|May </br> 2025|Connectly| Under construction.... </br> Tech-stack includes Blazor, ASP.NET Core, SQL, Entity Framework, Excel, Git, Jira. |[![My Skills](https://skillicons.dev/icons?i=cs,dotnet,css,html,bootstrap,sqlite,git,visualstudio&perline=2)](https://skillicons.dev)|
