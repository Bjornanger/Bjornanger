...
|------------------|------------------------|------------------------------------------------|-------|
|May </br> 2025|Connectly|Managing an Event plattform. </br> Tech-stack includes Blazor, ASP.NET Core, SQL, Entity Framework, XML, Git, Jira. |[![My Skills](https://skillicons.dev/icons?i=cs,dotnet,css,html,bootstrap,sqlite,git,visualstudio&perline=2)](https://skillicons.dev)|
